...
return [
    ...
    'attributes'             => [
        // Campos propios del aplicativo
        'rate' => 'tasa',
        'rate_type' => 'modalidad de la tasa',
        'rate_period' => 'periodo de capitalización',
        'rate_reference' => 'periodo de referencia',
        'rate_mode' => 'modo de la tasa',
        'principal' => 'capital',
        'periods' => 'número de cuotas',
        'payment_period' => 'periodicidad de las cuotas',
        'method' => 'método',
        'scheduled_extras' => 'cuotas extras',
        'scheduled_extras.*.period' => 'periodo de la cuota extra',
        'scheduled_extras.*.amount' => 'monto de la cuota extra',
        'extra_period' => 'periodo del abono extra',
        'extra_amount' => 'monto del abono extra',
        'behaviour' => 'comportamiento del abono',
        'grace_periods' => 'periodos de gracia',
        'grace_type' => 'tipo de gracia',
        'interest_timing' => 'cobro de intereses',
        'variation' => 'variación',
        'gradient_kind' => 'tipo de gradiente',
        'gradient_direction' => 'dirección del gradiente',
        'exchange_rate' => 'tasa de cambio',
        'exchange_changes' => 'tramos de la moneda',
        'exchange_changes.*.type' => 'movimiento del tramo',
        'exchange_changes.*.value' => 'porcentaje del tramo',
        'exchange_changes.*.periods' => 'periodos del tramo',
        'foreign_method' => 'forma de pago',
        'segments' => 'tramos de tasa',
        'segments.*.from' => 'inicio del tramo',
        'segments.*.rate' => 'tasa del tramo',
        'focal_date' => 'fecha focal',
        'solve_for' => 'incógnita a despejar',
        'unknown_period_amount' => 'monto del pago',
        'unknown_period_direction' => 'sentido del pago',
        'items' => 'flujos',
        'items.*.kind' => 'tipo del flujo',
        'items.*.direction' => 'sentido del flujo',
        'items.*.period' => 'periodo del flujo',
        'items.*.unknown' => 'incógnita del flujo',
        'items.*.amount' => 'monto del flujo',
        'items.*.coefficient' => 'coeficiente de X',
        'items.*.constant' => 'término constante',
        'items.*.count' => 'número de pagos',
        'items.*.step' => 'intervalo entre pagos',
        'items.*.variation' => 'variación del gradiente',
        'items.*.growth' => 'crecimiento del gradiente',
        'items.*.gradient_direction' => 'dirección del gradiente',
        // Genéricos de laravel-lang
        'address'                  => 'dirección',
